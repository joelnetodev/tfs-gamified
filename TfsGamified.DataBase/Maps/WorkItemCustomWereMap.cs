...
namespace TfsGamified.DataBase.Maps
{
    ...
    [DbInfraMap]
    public class WorkItemCustomWereMap : EntityTypeConfiguration<WorkItemCustomWere>
    {
        public WorkItemCustomWereMap()
            : this("dbo")
        {
        }

        public WorkItemCustomWereMap(string schema)
        {
            ToTable("tbl_WorkItemCustomWere", schema);
