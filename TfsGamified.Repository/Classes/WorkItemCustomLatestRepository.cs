...
{
    public class WorkItemCustomLatestRepository : DbInfraRepository<WorkItemCustomLatest>, IWorkItemCustomLatestRepository
    {
        public List<WorkItemCustomLatest> ConsultarPorItemsCoreLatest(List<WorkItemCoreLatest> WorkItemsCoreLatest)
        {
