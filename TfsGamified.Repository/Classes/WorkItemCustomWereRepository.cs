...
{
    public class WorkItemCustomWereRepository : DbInfraRepository<WorkItemCustomWere>, IWorkItemCustomWereRepository
    {
        public List<WorkItemCustomWere> ConsultarPorItemsCoreLatest(List<WorkItemCoreLatest> WorkItemsCoreLatest)
        {
