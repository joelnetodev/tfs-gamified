...
namespace TfsGamified.Entities
{
    ...
    public class WorkItemCoreWere
    {
        public int PartitionId { get; set; } // PartitionId (Primary key via unique index PK_tbl_WorkItemCoreWere)
        public int DataspaceId { get; set; } // DataspaceId (Primary key via unique index PK_tbl_WorkItemCoreWere)
        public int Id { get; set; } // Id (Primary key via unique index PK_tbl_WorkItemCoreWere)
        public int Rev { get; set; } // Rev
        public DateTime AuthorizedDate { get; set; } // AuthorizedDate
        public DateTime RevisedDate { get; set; } // RevisedDate (Primary key via unique index PK_tbl_WorkItemCoreWere)
